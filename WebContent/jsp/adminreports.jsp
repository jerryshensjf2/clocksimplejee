        ...
        <jsp:include page="../include/header.jsp" />
            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">  
                    <ul>
                            <li><a href="../jsp/mythisweekworkstatussummary.jsp">Employee Week Summary</a></li>
                            <li><a href="../jsp/mythismonthworkstatussummary.jsp">Employee Month Summary</a></li>
        					<li><a href="../jsp/thisyearsummary.jsp">Employee Year Summary</a></li>
 							<li><a href="../jsp/mythisweekworkstatussummary.jsp">Company Week Summary</a></li>
                            <li><a href="../jsp/mythismonthworkstatussummary.jsp">Company Month Summary</a></li>
        					<li><a href="../jsp/thisyearsummary.jsp">Company Year Summary</a></li>
                    </ul>                     
                    </div>
                    <!-- end div#welcome -->
                </div>
