            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">
						...
						<br>
						<br>
						<h3>Year <% Timestamp now=new Timestamp(System.currentTimeMillis()); 
									out.println(1900+now.getYear());
									out.println("<br/>Month " + (now.getMonth()));%></h3><br>
						Monthly work time:
						<%=(new ClockRecordServiceImpl().getLastMonthWorkSum(now,(User)session.getAttribute("userData"))).toString()%>
						 <table class="aatable">
                            <tr>
                                <th>UserId</th>
                                <th>EmpId</th>  
                            ...
                            <%                                     	
		                   		   List<AttendanceStatus> attendanceStatusList = new ClockRecordServiceImpl().getLastMonthWorkStatusSummary(now,(User)session.getAttribute("userData"));
