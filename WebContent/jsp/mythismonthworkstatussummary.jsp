            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">
						...
						<br>
						<br>
						<h3>Year <% out.println(1900+now.getYear());
									out.println("<br/>Month " + (now.getMonth()+1));%></h3><br>
						Monthly work time:
						<%=(new ClockRecordServiceImpl().getThisMonthWorkSum(now,(User)session.getAttribute("userData"))).toString()%>
						 <table class="aatable">
                            <tr>
                                <th>UserId</th>
                                <th>EmpId</th>  
                            ...
                            <%                                     	
		                   		   List<AttendanceStatus> attendanceStatusList = new ClockRecordServiceImpl().getThisMonthWorkStatusSummary(now,(User)session.getAttribute("userData"));
