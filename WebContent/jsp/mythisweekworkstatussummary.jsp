            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">
						...
						<br>
						<br>
						<h3>Year <% long weekCount =(now.getTime() - new Timestamp(now.getYear(),0,1,0,0,0,0).getTime() )/ (7L*24L*3600L*1000L) +1L;
									out.println("<br/>Week " + weekCount);%></h3><br>
						Weekly work time:
						<%=(new ClockRecordServiceImpl().getThisWeekWorkSum(now,(User)session.getAttribute("userData"))).toString()%>
						 <table class="aatable">
                            <tr>
                                <th>UserId</th>
                                <th>EmpId</th>  
                            ...
                            <%                                     	
		                   		   List<AttendanceStatus> attendanceStatusList = new ClockRecordServiceImpl().getThisWeekWorkStatusSummary(now,(User)session.getAttribute("userData"));
