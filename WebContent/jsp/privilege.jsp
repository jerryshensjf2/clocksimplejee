                        ...
                        <table class="aatable">
                            ...
                            <%
		                           ...
		                           for(int index=0;index < privList.size();index++){
		                               ...
		                               out.println("<tr>");
		                               out.println("<td><form action='../controller/AdminEditPrivilegeController' method='post'><input type='text' name='id1' size='8' value='"+priv.getId()+"'/></td>");                         
		                               ...
		                               out.println("<td><input type='hidden' name='id' value='"+priv.getId()+"'/><input type='submit' value='Edit' /></form>"+
		                                           "<form action='../controller/TogglePrivilegeAdminController' method='post'><input type='hidden' name='id' value='"+priv.getId()+"'/><input type='submit' value='Toggle Admin' /></form>"+
		                                           "<form action='../controller/ToggleCanDeleteController' method='post'><input type='hidden' name='id' value='"+priv.getId()+"'/><input type='submit' value='Toggle Can Delete'/></form>"+		                                         
		                                           "<form action='../controller/AdminDeletePrivilegeController' method='post'><input type='hidden' name='id' value='"+priv.getId()+"'/><input type='submit' value='Delete' /></form> </td>");
		                               out.println("</tr>");
		                           }
                            %>
                            <tr><form action='../controller/AdminAddPrivilegeController' method='post'>
