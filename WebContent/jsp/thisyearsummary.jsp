            ...
            <div id="page">
                <div id="content">
                    <div id="welcome">
						...
						<br>
						<br>
						<h3>Year <%=(new Timestamp(System.currentTimeMillis()).getYear() + 1900)%></h3><br>
						Yearly work time:
						<%=(new ClockRecordServiceImpl().getWholeThisYearWorkSum(new Timestamp(System.currentTimeMillis()),(User)session.getAttribute("userData"))).toString()%>
						 <table class="aatable">
                            <tr>
                                <th>UserId</th>
                                <th>EmpId</th>  
                            ...
                            <%                                     	
		                   		   List<AttendanceStatus> attendanceStatusList = new ClockRecordServiceImpl().getWholeThisYearWorkStatusSummary(new Timestamp(System.currentTimeMillis()),(User)session.getAttribute("userData"));
