    ...
    <body>
        ...
        <jsp:include page="../include/header.jsp"/>
            ...
            <div id="page">
                ...
                <table>
	                <tr><td  class="login">EmpID:</td><td><input type="text" name="empid" value="" style="width: 220px"/></td></tr>
	                <tr><td  class="login">Password:</td><td><input type="password" name="password" value="" style="width: 220px"/></td></tr>
	                <tr><td colspan="2"><input type="submit" value="login"/></td></tr>
                </table>
            </form>
                <a href="../login/loginviausernamepassword.jsp">Login via Username and Password</a><br />
