...
public class ToggleAdminController extends HttpServlet {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            clockService.toggleAdmin(user);
            System.out.println("ToggleAdminController");

            response.sendRedirect("../jsp/userfunctionadministration.jsp");
        } catch (Exception e){
        	e.printStackTrace();
         } finally {
            out.close();
