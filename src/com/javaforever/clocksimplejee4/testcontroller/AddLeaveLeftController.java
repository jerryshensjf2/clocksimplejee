...
public class AddLeaveLeftController extends BaseTestController {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException{
        ...
        try {
        	...
        	leaveLeft.setUserId(Long.valueOf(request.getParameter("userid")));
            ...
            leaveLeftService.createLeaveLeft(leaveLeft);
