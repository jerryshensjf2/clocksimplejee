...
public class EditClockRecordController extends BaseTestController {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	clockRecord.setId(Long.parseLong(request.getParameter("id")));
            ...
            clockRecordService.updateClockRecord(clockRecord);
