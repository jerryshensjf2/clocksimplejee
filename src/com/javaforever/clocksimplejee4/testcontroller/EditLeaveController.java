...
public class EditLeaveController extends BaseTestController{
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	leave.setId(Long.parseLong(request.getParameter("id")));
        	leave.setUserId(Long.parseLong(request.getParameter("userid")));
