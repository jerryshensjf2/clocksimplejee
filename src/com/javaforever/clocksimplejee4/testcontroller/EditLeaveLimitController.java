...
public class EditLeaveLimitController extends BaseTestController {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	leaveLimit.setId(Long.parseLong(request.getParameter("id")));
            ...
            leaveLimitService.updateLeaveLimit(leaveLimit);
