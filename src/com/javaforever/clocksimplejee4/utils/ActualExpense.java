...
public class ActualExpense implements IModel {
	...
	/**
	 * @param actualExpenseId
	 *            The actualExpenseId to set.
	 */
	...
	/**
	 * @param actualExpenseBatchId
	 *            The actualExpenseBatchId to set.
	 */
	...
	public String toString() {
		...
		sb.append("actualExpenseId:").append(getActualExpenseId()).append("\n")
				.append("amount:").append(getAmount()).append("\n").append(
						"budgetId:").append(getBudgetId()).append("\n").append(
						"exchangeRate:").append(getExchangeRate()).append("\n")
				.append("currencyId:").append(getCurrencyId()).append("\n")
				.append("expenseHeadId:").append(getExpenseHeadId()).append(
						"\n").append("inputTime:").append(getInputTime())
				.append("\n").append("month:").append(getMonth()).append("\n")
				.append("actualExpenseBatchId").append(
						getActualExpenseBatchId()).append("\n");
		return sb.toString();
	}
}